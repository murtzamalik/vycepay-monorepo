...
const columns: Column[] = [
  ...
  { key: 'menuCount', label: 'Menus', sortable: true },
...
export default function Page() {
  return <ListPage title="Role Management" description="Manage role access and action permissions." endpoint="/roles" columns={columns} clientSort />
}
